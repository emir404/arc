        ...
        <div className='pricing-cards w-full flex-col lg:flex-row flex gap-4'>
          ...
          <div className='w-full h-full flex flex-col p-8  rounded-2xl border bg-gray-300/20 border-gray-800/10 gap-3'>
            <div className='flex flex-col gap-1'>
              ...
              {
                mode === "monthly" ? (
                  <p className='font-semibold text-6xl my-2 text-gray-700 tracking-tighter pt-2'>$2999 <span className='text-lg text-gray-400 tracking-normal font-normal'>/per month</span></p>
                ) : (
                  <p className='font-semibold text-6xl my-2 text-gray-700 tracking-tighter pt-2'>$29995 <span className='text-lg text-gray-400 tracking-normal font-normal'>/per year</span></p>
                )
              }
            <div className='py-4 flex flex-col gap-4'>
              <div className='flex gap-3 items-center'>
